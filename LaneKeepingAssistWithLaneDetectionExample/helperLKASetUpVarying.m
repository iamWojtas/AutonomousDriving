...
modelName = 'LKATestBenchExampleVarying';
...
%% Generate data for initial pose for variable speed trajectory
Model_Init_Varying
[scenario1,roadCenters,laneSpecification] = createTestTrackScenario;
